...
Loading routes
--------------
To load a route on the map, you first have to open the :ref:`routes screen <sec-routes-screen>` by tapping the :ref:`route button <sec-route-button>` on the dashboard. Then select the tab 'Routes' to show the locally saved routes. 
