...
On the top right of the main screen you can find a handle with which you can open the :ref:`menu <sec-menu>`. 
...
On the bottom right corner of the map you can find a scale indicator. In the figure above the black horizontal line indicates a distance of 200 m. Using the scale indicator you can quickly estimate the distance between two points on the map. You can also use the :ref:`map ruler <ss-map-ruler>` to measure distances and angles more precisely.
