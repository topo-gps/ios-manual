...
- :ref:`Search <sec-searching>` - If you tap this item you can :ref:`search addresses and places <sec-search-addresses>` and :ref:`enter <sec-entering-coordinates>` and :ref:`scan <sec-scanning-coordinates>` coordinates.
...
- :ref:`More` - If you tap this item the more screen will be opneed. With the tabbar in the bottom you can access the various screens, like changing the :ref:`settings <ss-settings>`, view the :ref:`legend <ss-legend>`, and look up information about Topo GPS.
